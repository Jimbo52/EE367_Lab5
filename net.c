...
/* 
 * Create nonblocking connections(pipes) between switch and hosts  
 * assuming host physical IDs are 0, 1, ....
 */
...
/* host id: 0 , 1 switch id: 2. Total 4 links */
 ...
 * from the link array
 */
//I added a search index to get rid of the links that priously found
int netSwitchOutLink(linkArrayType * linkArray, int switchid, int searchindex) 
{
int i;
int index = -2;

for (i=searchindex; i<linkArray->numlinks; i++) {
   /* Store index if the outgoing link is found */
